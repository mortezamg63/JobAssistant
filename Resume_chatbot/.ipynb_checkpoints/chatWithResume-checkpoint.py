...
class ResumeChat:
    def __init__(self, directory, openai):
        self.openai = openai
        self.content = self.read_reports(directory)
        self.system_prompt = self.get_system_prompt(self.content)
        self.history = []

    def read_reports(self, directory):
    ...
    def get_system_prompt(self, content):
    ...
    def chat(self, message, history):
        system_prompt = self.get_system_prompt(self.content)
